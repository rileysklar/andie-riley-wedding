...
export default function Hero() {
  return (
    <div className="hero-gradient gap-4 text-[#f4f4f4] flex flex-col align-center justify-end bg-cover bg-top h-[80svh] flex items-center p-8">
      <h1 className="text-shadow-lg text-center text-6xl mb-4 drop-shadow-md">
      ...
      >
        <p
          className="text-md text-shadow-lg text-center mb-0 drop-shadow-md p-4 rounded-lg text-[#f4f4f4] "
          style={{
